...
public class Pracownicy_biurowi {
    ...
    private String rodzaj_pracownika_biurowego;
    ...
    public Pracownicy_biurowi(int pracownik_id, String imie, String drugie_imie, String nazwisko, String pesel, String data_urodzenia, int numer_telefonu, char plec, String numer_konta, String data_zatrudnienia, String data_zwolnienia, String rodzaj_pracownika_biurowego, String ulica, String numer_domu, String numer_lokalu, String miasto, String kod_pocztowy) {
        ...
        this.rodzaj_pracownika_biurowego = rodzaj_pracownika_biurowego;
        this.ulica = ulica;
    ...
    public String getRodzaj_pracownika_biurowego() {
        return rodzaj_pracownika_biurowego;
    }

    public void setRodzaj_pracownika_biurowego(String rodzaj_pracownika_biurowego) {
        this.rodzaj_pracownika_biurowego = rodzaj_pracownika_biurowego;
    }
    ...
    public String toString() {
        return "Pracownicy_biurowi{" +
                ...
                ", rodzaj_pracownika_biurowego='" + rodzaj_pracownika_biurowego + '\'' +
                ", ulica='" + ulica + '\'' +
